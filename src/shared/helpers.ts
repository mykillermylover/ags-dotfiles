...
export function isLeftClick(eventOrButton: Astal.ClickEvent | Astal.MouseButton) {
...
export function isRightClick(button: Astal.MouseButton): button is SECONDARY_BUTTON;
export function isRightClick(event: Astal.ClickEvent): boolean;
export function isRightClick(eventOrButton: Astal.ClickEvent | Astal.MouseButton) {
  if (eventOrButton instanceof Astal.ClickEvent) {
...
export function isMiddleClick(button: Astal.MouseButton): button is MIDDLE_BUTTON;
export function isMiddleClick(event: Astal.ClickEvent): boolean;
export function isMiddleClick(eventOrButton: Astal.ClickEvent | Astal.MouseButton) {
  if (eventOrButton instanceof Astal.ClickEvent) {
